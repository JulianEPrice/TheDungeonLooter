...
public class Player implements KeyListener {
	 ...
	 * Rendering
	 */
	private int renderDistanceW = 61;
	private int renderDistanceH = 23;
	...
	public void init(World world) {
		...
		render = new Rectangle(
				...
				(int) (pos.ypos - pos.getWorldLocation().ypos + pos.ypos - renderDistanceH * 32 / 2 + width / 2),
				renderDistanceW * 32,
				renderDistanceH * 32);
		...
		//RIGHT
		ani_right = new Animator(listLeft);
		ani_right.setSpeed(180);
		ani_right.play();
		
		//LEFT
		ani_left = new Animator(listRight);
			...
			if(!mapMove){
				...
				if(right) {
					...
					if(!Check.CollisionPlayerBlock(
							...
							new Point((int) (pos.xpos + GameLoop.map.xpos + height + moveAmountr) ,
								      (int) (pos.ypos + GameLoop.map.ypos + height)),
